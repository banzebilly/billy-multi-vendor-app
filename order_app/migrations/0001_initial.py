    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendors', models.ManyToManyField(blank=True, to='vendor_app.vendor')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('fooditem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='menu_app.fooditem')),
